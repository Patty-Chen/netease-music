...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__song_css__ = __webpack_require__(9);
...
let lyric = __WEBPACK_IMPORTED_MODULE_2__testdata_js__["a" /* data */][id].lyric
let songUrl = __WEBPACK_IMPORTED_MODULE_2__testdata_js__["a" /* data */][id].url
let name = __WEBPACK_IMPORTED_MODULE_2__testdata_js__["a" /* data */][id].name
...
let $lyric = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.lyric')
lyricArray.map((lyricObject)=>{
    if(lyricObject){
        let $p = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<p/>')
...
setInterval(()=>{
    ...
    if (secondsNextLine && currentSeconds > secondsNextLine){
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.lyric p')[currentLine - errorLines -1].removeAttribute('class')
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.lyric p')[currentLine - errorLines].setAttribute('class','current-line')
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./song.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./song.css");
